...
# 设置模型缓存目录,注意不要有中文路径
os.environ["TRANSFORMERS_CACHE"] = "D:/my_transformers_cache"  
#设置代理，方便访问谷歌的Gemini API
#os.environ['HTTP_PROXY'] = 'https://fsc.jiediandingyuejiji.homes/answer/land?token=124324aa90b640dc3ae1e11ddf401b50'
#os.environ['HTTPS_PROXY'] = 'https://fsc.jiediandingyuejiji.homes/answer/land?token=124324aa90b640dc3ae1e11ddf401b50'

# 使用系统代理
import requests
session = requests.Session()
session.trust_env = True  # 这会使用系统代理设置
...
# 初始化OpenAI客户端
client = OpenAI(
    api_key="sk-wLQ4Gg6fF1SqgSjeAtfqECIgjDQSVPmBYbX83obzA9U0u0tV",
